...
def page_4():
    ...
    st.text("")
    st.text("Here was a previous phase which is incorrect, please do not take into account.")
      #  "Here is the prediction phase, based on production models selected from Mlflow experiments.")
    st.markdown('---')
...
#            'XGBoost': 'models/xgboost_model_05.pkl',
